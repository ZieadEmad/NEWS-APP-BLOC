...
import 'package:news_app/screens/countries/egypt/cubit/cubit.dart';
...
class EgyptScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => EgyptCubit()..getNews(),
      child: BlocConsumer<EgyptCubit, EgyptStates>(
        listener: (context,state){},
        builder: (context,state){
          var News = EgyptCubit.get(context).news;
          return Scaffold(
            appBar: AppBar(
