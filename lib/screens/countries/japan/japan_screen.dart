...
import 'package:news_app/screens/countries/japan/cubit/cubit.dart';
...
class JapanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => JapanCubit()..getNews(),
      child: BlocConsumer<JapanCubit, JapanStates>(
        listener: (context,state){},
        builder: (context,state){
          var News = JapanCubit.get(context).news;
          return Scaffold(
            appBar: AppBar(
              title: Text('Japan News'),
            ),
